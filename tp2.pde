...
void setup() {
  ...
  t=loadFont("BurosamaITCbyBT-Bold-48.vlw");
  t2=loadFont("BurosawaITCbyBT-Bold-48.vlw");
}
void draw() {
  background(0);
  //f1-=3;
  ...
  textFont(t);
  text("quentin tarantino", width/2, height/2);
  h-=0.8;
  h2-=0.8;
  h3-=0.8;
  h4-=0.8;
